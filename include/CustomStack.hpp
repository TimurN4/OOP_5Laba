...
// //Can be 
// template <typename T>
// CustomStack<T>::CustomStack(std::pmr::memory_resource* mr) : size(0), allocator(mr) {
//     data = allocator.allocate(256);
//     capacity = 256;
// }

// //Cannot be 
// template <typename T>
// CustomStack<T>::CustomStack(std::pmr::memory_resource* mr) {
//     allocator = mr;
//     data = allocator.allocate(256);
//     capacity = 256;
//     size = 0;
...
T CustomStack<T>::top() {
    ...
    //else { throw std::bad_alloc("seg fault\n"); }
}
